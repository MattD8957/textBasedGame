...
public class BearBattle {
    ...
    public static void characterAttackChoiceOne(int strongAttackDMG, int bearHP){
    ...
    public static void characterAttackChoiceTwo(int standardAttackDMG, int bearHP){
    ...
    public static void characterAttackChoiceThree(int weakAttackDMG, int bearHP){
