...
public class GoblinBattleText {
    ...
    //Attack Text
    public static final void getGoblinFightTargetTextTwo(){
        System.out.println("Who will you attack? \n1 for leader\n2 for henchman");
      }
      public static final void getGoblinFightTargetTextThree(){
        System.out.println("Who will you attack? \n1 for leader\n2 for henchman\n3 for henchamn 2");
      }
      public static final void getGoblinFightTargetTextFour(){
        System.out.println("Who will you attack? \n1 for leader\n2 for henchman\n3 for henchamn 2\n4 for henchman 3");
      }
      public static final void getGoblinLeaderTargetText(){
        System.out.println("You attack the Leader.");
      }

    //Initial text
    public static final void getGoblinInitialText(){
