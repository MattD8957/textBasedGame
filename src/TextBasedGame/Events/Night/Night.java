...
public class Night {
    ...
    public void night() {
        ...
        if (choice == 2) {// Tree Dangerous
            ...
            GeneralUtils.pause(3);
            damageTaken =
                    GeneralUtils.randomNumber(NightConstants.CHOICE_ONE_DMG_TAKEN_UPPER_BOUND) + 1;
    ...
    public void getNightInitialText(double artifacts){
        System.out.println("Night falls, you can pay for a room in the town nearby or you can try to sleep under a nearby tree. \nIt costs 1 artifact to sleep in town, it is free to sleep under the tree but there might be dangers. \n1 for the town. \n 2 for the tree. \nYou have " + artifacts + " artifacts.");
      }
      ...
      public void getNightChoiceOneMorningText(int atk){
        System.out.println("You wake up feeling well rested and ready to go. Your attack is boosted " + atk + "dmg");
      }
      public void getNightChoiceTwoNightText(){
        System.out.println("You lay out a sleeping bag under the tree and hope nothing bothers you overnight.");
      }
      ...
      public void getNightChoiceTwoMorningAnimalText(int damageTaken, String name){
        System.out.println("During the night an animal attacked you! " + name + " fought it off but lost " + damageTaken + "HP.");
      }
